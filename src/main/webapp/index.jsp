...
<div class="container mt-6" style="margin-top: 70px;">
    <div class="row ">
        ...
        <div class="col-8">
           <form class="mt-6" method="post" accept-charset="utf-8" action="aes-encryption">
               <div class="mb-3">
               ...
               <div class="mb-3">
                   ...
                   <input type="text" class="form-control" required="required" name="key" placeholder="Entrer la clé">
               </div>
               <div class="mb-3">
               ...
               <div class="col-auto text-center">
                   <button type="submit" class="btn btn-primary mb-3">Encrypt</button>
               </div>
           </form>
        </div>
        <div class="col-2">
